...
class BME280:
    ...
    def read(self):
        ...
        if measurement is not None:
            ...
            print("Temperature: {:.2f}'C, Pressure: {:.2f}'C, Relative Humidity: {:.2f}%,  Altitude: {:.2f}%".format(measurement.temperature,measurement.pressure,measurement.humidity,altitude))
            time.sleep(1)
